  ...
  return (
    <div className="ds-page mx-auto max-w-5xl">
      <PageHeader
        ...
        eyebrow="إضافة جماعية"
        title="استيراد الموظفين"
        description="ارفع ملف Excel، راجع المطابقة والنتائج، ثم اعتمد الإضافة بعد التحقق."
        tone="operational"
        actions={<Link to="/staff"><Button variant="headerGhost"><ArrowRight aria-hidden size={16} /> العودة إلى الموظفين</Button></Link>}
      />
    ...
    <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-7">
      ...
      >
        ...
        <input
          ref={inputRef}
          type="file"
          aria-label="اختيار ملف استيراد الموظفين"
          accept=".xlsx"
          className="hidden"
